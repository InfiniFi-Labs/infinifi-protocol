...
contract IntegrationTestPendleV2FarmEthena is Fixture, IntegrationTestPendleCalldata {
    ...
    function setUp() public override {
        ...
        {
            accounting.setOracle(_USDE, address(new FixedPriceOracle(address(core), 1e18)));
